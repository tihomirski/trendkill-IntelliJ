...
public class BrowserLauncher {
    ...
    private static Object getBasicServiceObject() {
        ...
        try {
            ...
            lookupMethod = serviceManagerClass.getMethod("lookup",
...
// + 4/27/2004 USHIK +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    /**
     * This method open url at default browser by using JNLP.
     * If JNLP not available (start of application not trought Java WebStart)
     * the its return false.
     */
    public static boolean showDocument(String sUrl) {
        ...
        //gets BasicService class
        basicServiceClass = getBasicServiceClass();
        //gets BasicService object
        basicServiceObject = getBasicServiceObject();
        if (basicServiceClass == null || basicServiceObject == null) {
            return false;
        }
        try {
            url = new URL(sUrl);
        ...
        try {
            method = basicServiceClass.getMethod(
                    "showDocument", new Class[]{URL.class});
            //invokes BasicService`s method
            resultBoolean = (Boolean) method.invoke(basicServiceObject,
                                                    new Object[]{url});
