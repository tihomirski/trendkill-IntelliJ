...
public class MessageBoxRunnable implements Runnable {
    ...
    public void run() {
        ...
        String title = TradeApp.getInst().getResourceManager().getString("IDS_MAINFRAME_SHORT_TITLE");
        JOptionPane.showMessageDialog(TradeApp.getInst().getMainFrame(), message, title, JOptionPane.ERROR_MESSAGE);
    }
}
