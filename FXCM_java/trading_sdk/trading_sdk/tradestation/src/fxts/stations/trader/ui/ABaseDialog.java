 ...
 */
public abstract class ABaseDialog extends JDialog implements ComponentListener {
    protected static final Log LOG = LogFactory.getLog(ABaseDialog.class);
     ...
     */
    protected ABaseDialog(Frame aOwner) {
        super(aOwner);
