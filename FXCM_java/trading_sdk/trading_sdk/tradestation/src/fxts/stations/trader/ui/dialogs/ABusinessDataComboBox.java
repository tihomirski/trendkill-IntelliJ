 ...
 */
public abstract class ABusinessDataComboBox extends KeySensitiveComboBox implements ISignalListener {
    /**
     ...
     */
    protected ABusinessDataComboBox() {
        mLogger = LogFactory.getLog(ABusinessDataComboBox.class);
    }
